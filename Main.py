...
class Main:
    ...
    def create_structure(self):
        ...
        self.my_button = ttk.Button(self.my_informations_frame, text="Sair", command=self.inst.destroy)
        ...
        self.my_informations.heading('pages_value', text="Total", anchor=CENTER)
    ...
    def insert_data(self,file,pages,idd_value):
        ...
        self.my_informations.insert(parent='', 
                index='end', iid=idd_value, text='',
                values=(file, pages))
        ...
        for path, _, files in walk(self.convert_away(self.location)):
            ...
            for file in files:
                ...
                if self.verify_the_file_is_pdf(file):
                    ...
                    idd_value = self.insert_data(file, self.pdf_pages(finalPath),idd_value)
                    self.set_totalPages(self.get_totalPages() + self.pdf_pages(finalPath))
